...
from Tierwaerter import Tierwaerter
 
list_tiere = []
list_tierwaerter = []
pinguin = Tiere("Fisch", "15", 3, "12:00", "schwimmen", "Jackie", "Vogel") #Erstellen eines Pinguin-Objekts (Instanziierung)
...
Bob = Tierwaerter("Bob", 101, "Vogel")
Alice = Tierwaerter("Alice", 102, "Raubkatze")
